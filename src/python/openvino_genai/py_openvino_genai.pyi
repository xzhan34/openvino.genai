...
class Qwen3ASRInferenceEngine:
    @typing.overload
    def __init__(self, models_path: os.PathLike | str | bytes, device: str = ..., max_new_tokens: typing.SupportsInt = ..., audio_model_path: os.PathLike | str | bytes | None = ..., cache_model: bool = ..., openvino_cache_dir: str | None = ..., **kwargs) -> None:
        ...
